class Student:
    ...
    DEFAULT_SUBJECT = ["Calculus", "Chemistry"]
...
if __name__ == "__main__":
    student1 = Student (name="JEYMS", grade=1.00, subject=["Calculus", "Chemistry"])
    ...
    student1 = Student(name="JEYMS", grade=4.00, subject=["Calculus", "Chemistry"])
    student1.print_student_info_method()
    if Student.is_grade_passing(student1.grade):
        print("passed")
    else:
